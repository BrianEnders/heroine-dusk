...
function minimap_init() {
	...
	minimap.img.onload = function () {
		minimap_img_onload();
	};

	minimap.cursor.src = "images/interface/minimap_cursor.png";
	minimap.cursor.onload = function () {
		minimap_cursor_onload();
	};
}
...
function minimap_render_icon(screen_x, screen_y, icon_type) {
	ctx.drawImage(
	minimap.img, icon_type * MINIMAP_ICON_SIZE * PRESCALE, 0, MINIMAP_ICON_SIZE * PRESCALE, MINIMAP_ICON_SIZE * PRESCALE, screen_x * SCALE, screen_y * SCALE, MINIMAP_ICON_SIZE * SCALE, MINIMAP_ICON_SIZE * SCALE);
}

function minimap_render_cursor(screen_x, screen_y, cursor_dir) {
	ctx.drawImage(
	minimap.cursor, cursor_dir * MINIMAP_ICON_SIZE * PRESCALE, 0, MINIMAP_ICON_SIZE * PRESCALE, MINIMAP_ICON_SIZE * PRESCALE, screen_x * SCALE, screen_y * SCALE, MINIMAP_ICON_SIZE * SCALE, MINIMAP_ICON_SIZE * SCALE);
}